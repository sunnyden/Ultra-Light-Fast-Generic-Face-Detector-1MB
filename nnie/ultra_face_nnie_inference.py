...
parser.add_argument('--wk_path', default="model/RFB.wk", type=str, help='wk model path')
...
def inference():
    net = NNIE(file=args.wk_path,ipaddr='192.168.31.20',port=8888)
    ...
    for file_path in listdir:
        ...
        cv2.imshow("ultra_face_ace_nnie_py", img_ori)
        cv2.waitKey(-1)
